 ...
 *
 * DO NOT EDIT THIS FILE BY HAND. It is generated in the one source at Polymathie-Studio/tools
 * (machine-readable/craft/domains/grants/grain/) by generate-primitives.mjs from grain-notation.md,
 * and synced into consuming servers. Edit the notation in the one source and regenerate; a hand
 * edit here will not survive.
 *
