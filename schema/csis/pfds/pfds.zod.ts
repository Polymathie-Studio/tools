...
export const PrecisionReview = z.object({
  ...
  "name": z.string()
}).strict()).describe("Section 2. The ten corollaries the review assesses against, each a structured precision condition with its two failure directions."),
...
}).strict()).describe("Section 7. The precision-failure patterns the review keys deficits to, each a structured signature-and-response."),
